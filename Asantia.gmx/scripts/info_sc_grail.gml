...
if slotid[n].item=grail_scythe
{
 ...
 draw_rarity()
 ////6 steps
 draw_text_transformed(slotx[n]-(r_width*global.ui_size)+3*global.ui_size,sloty[n]+23*global.ui_size,"2-H melee",global.ui_size/3,global.ui_size/3,0)
 //
 ...
 draw_text_transformed(slotx[n]-(r_width*global.ui_size)+30*global.ui_size,sloty[n]+41*global.ui_size,25,global.ui_size/3,global.ui_size/3,0)
