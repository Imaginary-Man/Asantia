...
if slotid[n].item=2
{
 ...
 draw_rarity()
 ////6 steps
 draw_text_transformed(slotx[n]-(r_width*global.ui_size)+3*global.ui_size,sloty[n]+23*global.ui_size,"2-H ranged",global.ui_size/3,global.ui_size/3,0)
 //
 ...
 draw_text_transformed(slotx[n]-(r_width*global.ui_size)+30*global.ui_size,sloty[n]+41*global.ui_size,120,global.ui_size/3,global.ui_size/3,0)
