...
part_type_size(particle1,0.2,0.2,0,0);
part_type_scale(particle1,0.5,0.5);
part_type_color2(particle1,color,color);//part_type_color2(particle1,16777153,16777039)
...
part_type_scale(particle2,0.5,0.5);
part_type_color3(particle2,color,color,color);
