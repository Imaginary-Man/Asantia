...
if slotid[n].item=1
{
 ...
 draw_rarity()
 ////6 steps
 draw_text_transformed(slotx[n]-(r_width*global.ui_size)+3*global.ui_size,sloty[n]+23*global.ui_size,"Helmet",global.ui_size/3,global.ui_size/3,0)
 //
 ...
 draw_text_transformed(slotx[n]-(r_width*global.ui_size)+3*global.ui_size,sloty[n]+41*global.ui_size,"Resist",global.ui_size/3,global.ui_size/3,0)
 draw_text_transformed(slotx[n]-(r_width*global.ui_size)+3*global.ui_size,sloty[n]+47*global.ui_size,"sta",global.ui_size/3,global.ui_size/3,0)
 //
 draw_set_color(c_white)
